...
#' @param output_dir Character. Path to output directory for saving the object. If NULL, object is not saved to file (default: NULL)
#'
...
create_seurat_obj <- function(data_dir,
  ...
  if (!is.null(output_dir)) {
    ...
    cat("  ✓ Object created (not saved to file)\n")
    cat("\n")
  }
